    ...
    <div className="min-h-screen bg-background">
      ...
      <div
        className={cn(
          ...
          themeId === 'ocean' && 'bg-gradient-to-r from-primary/5 via-background to-accent/5',
          themeId === 'kilimanjaro' && 'bg-foreground text-background',
          themeId === 'serengeti' && 'bg-gradient-to-br from-primary/5 to-accent/5'
        )}
      >
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
            ...
            <span>/</span>
            <span className={cn(themeId === 'kilimanjaro' && 'text-background/70')}>
              {category.name}
            </span>
          </div>
            ...
            <div className="flex items-center gap-4">
              <div
                className={cn(
                  ...
                  themeId === 'ocean' && 'rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20',
                  themeId === 'kilimanjaro' && 'bg-primary',
                  themeId === 'serengeti' && 'rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10'
                )}
              >
                <Icon
                  className={cn(
                    'w-7 h-7',
                    themeId === 'kilimanjaro' ? 'text-primary-foreground' : 'text-primary'
                  )}
                />
              </div>
              <div>
            ...
            <div className="w-full md:w-auto md:min-w-[300px]">
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    'pl-9',
                    themeId === 'kilimanjaro' && 'rounded-none border-background/30 bg-background/10 text-background placeholder:text-background/50',
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            ...
            {category.subcategories.map((sub) => (
              <Button
                ...
                size="sm"
                className={cn(
                  themeId === 'kilimanjaro' && 'rounded-none uppercase font-bold border-background/30 text-background hover:bg-background hover:text-foreground',
                  themeId === 'ocean' && 'rounded-full',
                  themeId === 'serengeti' && 'rounded-full',
                  filters.subcategory !== sub.id && themeId === 'kilimanjaro' && 'bg-transparent'
                )}
              ...
              <div className="text-center py-16">
                <div
                  className={cn(
                    ...
                    themeId === 'ocean' && 'rounded-full bg-gradient-to-br from-primary/10 to-accent/10',
