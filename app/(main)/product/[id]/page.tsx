...
export default function ProductDetailPage() {
  ...
  // Generate multiple images for demo (using same image with different parameters)
  const productImages = product.images[0]?.startsWith('http')
    ? [
        product.images[0],
        product.images[0].replace('w=800', 'w=801'),
        product.images[0].replace('w=800', 'w=802'),
      ]
    : ['/placeholder.jpg'];
                  ...
                  <div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                      ...
                      {product.negotiable && (
                        <Badge
                          variant="outline"
                          className={cn(themeId === 'kilimanjaro' && 'rounded-none uppercase')}
                        >
                          Negotiable
                        </Badge>
                      )}
            ...
            >
              ...
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li>- Never send money in advance or use mobile money for deposits</li>
                </ul>
              </CardContent>
            </Card>
          </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <h3 className="font-semibold truncate">{product.sellerName}</h3>
