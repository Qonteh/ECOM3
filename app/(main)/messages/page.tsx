          ...
          {filteredConversations.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-64 px-4 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Start chatting with sellers by clicking &quot;Start Chat&quot; on any product
              </p>
              <Link href="/">
        ...
        {activeConversation ? (
          <>
              ...
              <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem>
                      <Link href={`/product/${activeConversation.productId}`} className="flex items-center gap-2">
            ...
            <Link
              ...
              className="flex items-center gap-4 p-3 border-b border-border bg-muted/20 hover:bg-muted/40 transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium truncate">{activeConversation.productTitle}</p>
          ...
          <div className="flex-1 flex items-center justify-center text-center p-8">
            <div>
              ...
              <p className="text-muted-foreground max-w-sm">
                Choose a conversation from the list to start messaging or browse products to start a new chat.
              </p>
            </div>
          </div>
        )}
