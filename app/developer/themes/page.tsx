...
export default function ThemeDesignPage() {
  ...
  const handleApplyTheme = async (templateId: string) => {
    ...
    setIsSaving(false);
    toast.success(`Theme "${designTemplates.find(t => t.id === templateId)?.name}" applied successfully!`);
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex gap-1">
                {currentTheme && Object.values(currentTheme.preview).map((color, i) => (
                  <div
                    key={i}
              ...
              <div>
                <p className="font-semibold">Current Theme: {currentTheme?.name}</p>
      ...
      <Tabs defaultValue="templates" className="space-y-6">
        ...
        <TabsContent value="templates" className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge variant="secondary" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">All</Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">Modern</Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">Classic</Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">Minimal</Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">Bold</Badge>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {designTemplates.map((template) => (
              ...
              >
                ...
                >
                  {/* Mini Preview UI */}
                  <div className="absolute inset-4 rounded-lg shadow-sm overflow-hidden" style={{ backgroundColor: template.colors.background }}>
                    {/* Header bar */}
                    <div className="h-6 px-2 flex items-center gap-1" style={{ backgroundColor: template.colors.primary }}>
                      <div className="w-8 h-2 rounded" style={{ backgroundColor: 'rgba(255,255,255,0.5)' }} />
                      <div className="flex-1" />
                      <div className="w-4 h-2 rounded" style={{ backgroundColor: 'rgba(255,255,255,0.5)' }} />
                    </div>
                    {/* Content area */}
                    <div className="p-2 flex gap-2">
                      <div className="w-12 h-12 rounded" style={{ backgroundColor: template.colors.secondary }} />
                      <div className="flex-1 space-y-1">
                        <div className="h-2 w-3/4 rounded" style={{ backgroundColor: template.colors.primary + '40' }} />
                        <div className="h-2 w-1/2 rounded" style={{ backgroundColor: template.colors.accent + '40' }} />
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="p-4">
                  ...
                  >
                    ...
                    {selectedTemplate === template.id ? 'Applied' : 'Apply Theme'}
                  </Button>
                </CardContent>
              </Card>
            ))}
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setCustomLayout(prev => ({ ...prev, cardStyle: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setCustomLayout(prev => ({ ...prev, buttonStyle: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setCustomLayout(prev => ({ ...prev, spacing: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustomLayout(prev => ({ ...prev, borderRadius: e.target.value }))}
                    className="cursor-pointer"
                  />
                </div>

                <Button onClick={handleSaveCustomTheme} className="w-full mt-4" disabled={isSaving}>
                  {isSaving ? (
                    <RefreshCw className="w-4 h-4 mr-2 animate-spin" />
                  ) : (
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>See how your theme looks on different devices</CardDescription>
                </div>
            ...
            <CardContent>
              <div className="flex justify-center">
                ...
                >
                  ...
                  {/* Preview Content */}
                  <div className="p-6 min-h-[500px]" style={{
                    background: selectedDesign ? selectedDesign.colors.background : '#fff'
                  }}>
                    {/* Mock Header */}
                    <div 
                      className="rounded-lg p-4 mb-6"
                      style={{ backgroundColor: selectedDesign?.colors.primary }}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-lg bg-white/20" />
                          <div className="text-white font-bold">Soko Tanzania</div>
                        </div>
                        <div className="flex gap-2">
                    ...
                    <div className="text-center mb-8">
                      <h2 className="text-2xl font-bold mb-2" style={{ color: selectedDesign?.colors.primary }}>
                      ...
                      <div className="flex justify-center gap-2">
                        ...
                        <div 
                          ...
                          style={{ borderColor: selectedDesign?.colors.primary, color: selectedDesign?.colors.primary }}
                        >
                          Browse
                        </div>
                      </div>
                      ...
                      {[1, 2, 3, 4].map((i) => (
                        ...
                        >
                          <div 
                            ...
                            style={{ backgroundColor: selectedDesign?.colors.secondary + '40' }}
                          />
                          <div className="text-sm font-semibold" style={{ color: selectedDesign?.colors.primary }}>
                            TZS 150,000
                          </div>
