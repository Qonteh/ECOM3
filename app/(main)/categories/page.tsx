            ...
            return (
              <Card
                ...
                className={cn(
                  ...
                  themeId === 'ocean' && 'rounded-2xl backdrop-blur-sm bg-card/80',
                  themeId === 'kilimanjaro' && 'rounded-none border-2 hover:border-primary',
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        themeId === 'ocean' && 'rounded-full bg-gradient-to-br from-primary/20 to-accent/20',
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">{category.nameSwahili}</p>
                    </div>
                    <Badge
                      variant="secondary"
                      className={cn(
                        themeId === 'kilimanjaro' && 'rounded-none uppercase text-xs font-bold',
