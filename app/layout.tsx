...
export const metadata: Metadata = {
  ...
  description: 'Tanzania\'s leading online marketplace. Buy and sell electronics, vehicles, property, fashion, and more. Nunua na Uza mtandaoni.',
  keywords: ['Tanzania', 'marketplace', 'buy', 'sell', 'online shopping', 'classified ads', 'Dar es Salaam', 'Soko'],
...
export default function RootLayout({
  ...
  return (
    <html lang="sw" className={`${inter.variable} ${geistMono.variable} bg-background`}>
