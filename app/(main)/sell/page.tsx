            ...
            <div className="flex items-center gap-4">
              <Link href="/">
                <Button
                  variant="ghost"
                  size="icon"
                  className={cn(themeId === 'kilimanjaro' && 'text-background hover:bg-background/10')}
                >
                  ...
                  {categories.map((category) => (
                    <button
                      ...
                      className={cn(
                        ...
                        formData.categoryId === category.id && 'border-primary bg-primary/5',
                        themeId === 'safari' && 'rounded-xl',
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground">{category.nameSwahili}</p>
                    </button>
                  ))}
                </div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedCategory.subcategories.map((sub) => (
                        <Badge
                          key={sub.id}
                          variant={formData.subcategoryId === sub.id ? 'default' : 'outline'}
                          className={cn(
                            'cursor-pointer',
                            themeId === 'kilimanjaro' && 'rounded-none'
                          )}
            ...
            >
              ...
              <CardContent>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    For demo purposes, click &quot;Add Photo&quot; to add sample images. In a real app, you would upload your own photos.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-semibold mt-1">{formData.title}</h3>
                  </div>

                  <div className="flex flex-wrap gap-2">
                    <Badge variant="outline" className="capitalize">{formData.condition}</Badge>
                    {formData.negotiable && <Badge variant="outline">Negotiable</Badge>}
          ...
          <div className="flex justify-between mt-6">
            ...
            {currentStep === 'review' ? (
              <Button
                ...
                className={cn(themeId === 'kilimanjaro' && 'rounded-none uppercase font-bold')}
              >
